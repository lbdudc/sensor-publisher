...
public class DownloadResource {
    ...
    @RequestMapping(value = "/raster/{idResource}", method = RequestMethod.GET)
    public void downloadRasterFile(@PathVariable Long idResource, HttpServletResponse response) throws IOException, FileNotFoundException {
        downloadService.downloadFile(response, uploadPath + "/raster/" + idResource + "/");
    }
    /*% } %*/
