...
public class DownloadService {
  ...
  /*% if (feature.DM_DI_DF_Raster) { %*/
    public void downloadFile(HttpServletResponse response, String uri) throws IOException, FileNotFoundException {

      File downloadFile = fileUtil.getFileUnique(uri);
      ...
      if (downloadFile.exists() && !downloadFile.isDirectory()) {
        ...
        throw new FileNotFoundException("File \"" + uri + "\" not found", HttpStatus.NOT_FOUND);
      }
    }
  /*% } %*/
